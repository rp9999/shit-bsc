...
(0, config_1.task)(task_names_1.TASK_COMPILE, 'Compiles the entire project, building all artifacts')
    ...
    .setAction(async ({ noTypechain }, _, runSuper) => {
...
(0, config_1.subtask)(task_names_1.TASK_COMPILE_SOLIDITY_COMPILE_JOBS, 'Compiles the entire project, building all artifacts').setAction(async (taskArgs, { run }, runSuper) => {
    ...
    await run(constants_1.TASK_TYPECHAIN_GENERATE_TYPES, { compileSolOutput });
...
(0, config_1.subtask)(constants_1.TASK_TYPECHAIN_GENERATE_TYPES)
    ...
    const artifactPaths = (0, lodash_1.uniq)(artifactFQNs.map((fqn) => artifacts._getArtifactPathFromFullyQualifiedName(fqn)));
