    ...
    async export(options) {
        ...
        if (options.exportAll !== undefined) {
            ...
            for (const split of splitted) {
                if (split) {
                    ...
                    fs_extra_1.default.writeFileSync(split, JSON.stringify(all, null, '  ')); // TODO remove bytecode ?
                }
            }
        ...
        if (options.export !== undefined) {
            ...
            for (const split of splitted) {
                if (split) {
                    fs_extra_1.default.ensureDirSync(path_1.default.dirname(split));
                    fs_extra_1.default.writeFileSync(split, JSON.stringify(singleExport, null, '  ')); // TODO remove bytecode ?
                }
            }
