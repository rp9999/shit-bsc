        ...
        if (changesDetected) {
            if (!proxy) {
                ...
                if (expectedAddress && deterministicDiamondAlreadyDeployed) {
                    proxy = Object.assign(Object.assign({}, Diamond_json_1.default), { address: expectedAddress, args: diamondConstructorArgs });
                    ...
                    proxy = Object.assign(Object.assign({}, Diamond_json_1.default), { address: proxyAddress, receipt: createReceipt, transactionHash: createReceipt.transactionHash, args: diamondConstructorArgs });
                    await saveDeployment(proxyName, proxy);
                }
